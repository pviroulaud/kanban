...
namespace Kanban.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult listar([FromForm]filtroBusquedaDTO filtro)
        {
            ...
            var a = _servicioIncidencia.listar(filtro);
        ...
        public IActionResult listarIncidencias()
        {
            ...
            var a = _servicioIncidencia.listarNombreIncidencias();
        ...
        [HttpGet("listarIncidenciasProyecto")]
        [Authorize]
        public IActionResult listarIncidenciasProyecto(int proyectoId)
        {

            var a = _servicioIncidencia.listarNombreIncidencias( proyectoId);
