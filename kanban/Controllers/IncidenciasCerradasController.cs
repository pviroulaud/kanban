...
namespace Kanban.Controllers
{
    ...
    public class IncidenciasCerradasController : Controller
    {
        ...
        public IncidenciasCerradasController(ILogger<HomeController> logger,
            IincidenciaSrvc servicioIncidencia,IproyectoSrvc servicioProyecto,ItareaSrvc servicioTareas,
             Ijwt JWT)
        {
            _JWT = JWT;
            _logger = logger;
        ...
        public IActionResult listar([FromForm]filtroBusquedaDTO filtro)
        {
            ...
            var a = _servicioIncidencia.listar(filtro,true).Where(x=>x.estadoId==6).ToList();
        ...
        public IActionResult listarIncidencias()
        {
            ...
            var a = _servicioIncidencia.listarNombreIncidenciasCerradas();
        ...
        [HttpGet("listarIncidenciasCerradasProyecto")]
        [Authorize]
        public IActionResult listarIncidenciasCerradasProyecto(int proyectoId)
        {

            var a = _servicioIncidencia.listarNombreIncidenciasCerradas( proyectoId);
